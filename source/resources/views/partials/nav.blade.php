...
<pageslide
    ...
    <div>
        <nav class="Navigation">
            ...
            <a class="Navigation__link" href="#performers-instructors" ng-click="showMenu = false" scroll-to="performers-instructors">Performers &amp; Instructors</a>
            ...
            <a class="Navigation__link" href="#schedule-workshops" ng-click="showMenu = false" scroll-to="schedule-workshops">Schedule &amp; Workshops</a>
